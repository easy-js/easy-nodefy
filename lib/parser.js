...
var parser = {
   ...
   */
  convert: function (raw, defineNode) {
    // parse define
    ...
    // conversion
    output += parser.convertMappings(defineArgsNode, factoryNode);
   ...
   */
  convertMappings: function (defineArgsNode, factoryNode) {
